...
Текущий трек: **Track 0 — Workspace Foundation** (in progress). Последний завершённый шаг — **018: Root README + API/web runbook**. Полный план и прогресс: [`docs/development-roadmap.md`](docs/development-roadmap.md).
