...
**Track 0 — Workspace Foundation** (001–032) и **Track 1 — Platform Core** (033–056) закрыты. **Track 2 — Auth and Identity** сейчас выполнен до **098** включительно: последние уроки — [lesson-097](./lessons/lesson-097-service-api-key-auth-stub.md) про service/API key stub и [lesson-098](./lessons/lesson-098-oauth-social-login-deferred-adr.md) про отложенный OAuth/social login ADR. Следующий шаг — **099** (MFA roadmap note + threat model touch-up) в [development-roadmap.md](./development-roadmap.md). Нумерация шагов 090+ обновлена — [ADR-003](./adr/003-roadmap-renumber-090-plus.md).
