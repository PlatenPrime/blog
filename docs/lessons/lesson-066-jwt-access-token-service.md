...
- Следующий шаг — [lesson-067](./lesson-067-jwt-strategy-auth-guard.md): Passport, guard, `accessToken` в login; затем [lesson-068](./lesson-068-current-user-decorator.md).
