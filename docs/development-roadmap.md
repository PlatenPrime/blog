...
| Step | Title                                                 | Verify                          |
| ---- | ----------------------------------------------------- | ------------------------------- |
| 057  | Database module: Postgres + ORM bootstrap             | `nx run api:build`              |
| 058  | Datasource config from validated env (`DATABASE_URL`) | `nx run api:test`               |
| 059  | Migration workflow + baseline schema                  | migrate up/down smoke           |
