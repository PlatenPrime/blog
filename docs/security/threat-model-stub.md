...
| DoS                    | Login/reset spam, expensive queries          | Per-email login lockout (**074**); reset/resend rate limits per email + IP (**091**); global throttler baseline (**092** planned); prod tuning (**292–293**); request timeout (**053**)                                                                       |
