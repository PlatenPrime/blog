...
**Status:** living stub — auth controls mapped through step **096**; full expansion in Track 7 step **305** and capstone **328**.
...
| Information disclosure | Account enumeration, JWT PII, error oracle   | Login/reset neutral messages (**065**, **077**); no email in access JWT (**066**, **084**); log redaction (**047**); friendly 409 on duplicate email (**064**); auth failures use the shared error envelope (**096**)                                         |
